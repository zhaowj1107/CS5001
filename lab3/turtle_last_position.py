...
from PositionService import get_position_x, get_position_y, record_position, \
    change_status_of_set_position, check_if_position_is_set, \
    record_position_x, record_position_y
...
def get_click(x, y):
    if check_if_position_is_set() is False:
        ...
        print("you clicked at ({}, {}) click! last click\
 was at ({}, {})\n".format(x, y, x_last, y_last))
        if y > y_last:
            print("this y was greater!\n")
        elif y == y_last:
            print("this y is equal to last click's y")
        else:
